// app/homePage/HomeContent.client.tsx
"use client";
...
export default function HomeContent() {
  ...
  const poznajNasRef = useRef<HTMLDivElement>(null);
  const coOferujemyRef = useRef<HTMLDivElement>(null);
  ...
  // Update counters for clients and recipes
  useEffect(() => {
    const klientTimer = setInterval(() => {
    ...
    const przepisTimer = setInterval(() => {
  ...
  return (
    <div>
        ...
        <div className="max-w-3xl mx-auto">
          {pytania.map((p, indeks) => (
            <div key={indeks} className="border-b border-gray-700">
              ...
              >
                <span className="font-semibold">{p.pytanie}</span>
      ...
      {/* Section: Poznaj nas */}
      <div className="bg-gray-700 py-10" ref={poznajNasRef}>
